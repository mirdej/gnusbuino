// bootloader for the gnusb - open source usb sensor board

// original copyrighht notice
 ...
 * This Revision: $Id: bootloaderconfig.h 449 2007-12-13 22:25:49Z cs $
 */
...
#define  SIGNATURE_BYTES             0x1e, 0x96, 0x0A, 0     /* ATMega644P */
//#define  SIGNATURE_BYTES             0x1e, 0x96, 0x09, 0     /* ATMega644 */
...
static inline void  bootLoaderInit(void)
{
	...
	PORTB 	= 0x00;		// make sure pull-up resistors are turned off
	DDRC 	= 0x00;		// set all pins to input
	PORTC 	= 0x00;		// make sure pull-up resistors are turned off
	DDRD |= (1 << 5);				// set led pin to output
